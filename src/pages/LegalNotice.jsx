...
const LegalNotice = () => {
  return (
    <>
      <Helmet>
        <title>Aviso legal | ENCAPACO</title>
          ...
          <section id="titular">
            ...
            <div className="prose prose-neutral max-w-none">
              ...
              <ul className="mt-6 space-y-4 text-neutral-dark/80">
                ...
                <li><strong>CIF / NIF:</strong> Disponible bajo solicitud a través de los canales de contacto indicados en este Aviso Legal.</li>
