      ...
      <div className="space-y-12">
        ...
        <section id="gestion">
          ...
          <ul className="grid md:grid-cols-2 gap-4 text-sm font-bold uppercase tracking-[0.2em] text-neutral-dark/40 list-none p-0">
            <li><span className="text-sierra-gold mr-2">/</span> Chrome</li>
            <li><span className="text-sierra-gold mr-2">/</span> Firefox</li>
            <li><span className="text-sierra-gold mr-2">/</span> Safari</li>
            <li><span className="text-sierra-gold mr-2">/</span> Microsoft Edge</li>
          </ul>
        </section>
